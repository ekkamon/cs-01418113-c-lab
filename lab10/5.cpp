...
public:
    ...
    string toString()
    {
        stringstream hour, minute, second, output;

        hour << setfill('0') << setw(2) << this->hour;
        minute << setfill('0') << setw(2) << this->minute;
        second << setfill('0') << setw(2) << this->second;
        output << hour.str() << ":" << minute.str() << ":" << second.str();
